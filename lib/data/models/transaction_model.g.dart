...
const TransactionModelSchema = CollectionSchema(
  ...
  properties: {
    r'account': PropertySchema(
      ...
      name: r'account',
      type: IsarType.byte,
      enumMap: _TransactionModelaccountEnumValueMap,
    ),
    ...
    r'tag': PropertySchema(
      ...
      name: r'tag',
      type: IsarType.byte,
      enumMap: _TransactionModeltagEnumValueMap,
    ),
...
void _transactionModelSerialize(
  ...
  writer.writeByte(offsets[4], object.tag.index);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.account =
      _TransactionModelaccountValueEnumMap[reader.readByteOrNull(offsets[0])] ??
          AccountType.cash;
  ...
  object.id = id;
  object.tag =
      _TransactionModeltagValueEnumMap[reader.readByteOrNull(offsets[4])] ??
          TransactionTag.none;
  object.type =
...
P _transactionModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_TransactionModelaccountValueEnumMap[
    ...
    case 4:
      return (_TransactionModeltagValueEnumMap[reader.readByteOrNull(offset)] ??
          TransactionTag.none) as P;
    case 5:
...
const _TransactionModelaccountEnumValueMap = {
  'cash': 0,
  'bank': 1,
};
const _TransactionModelaccountValueEnumMap = {
  0: AccountType.cash,
  1: AccountType.bank,
};
const _TransactionModeltagEnumValueMap = {
  'none': 0,
  'primer': 1,
  'sekunder': 2,
  'tersier': 3,
};
const _TransactionModeltagValueEnumMap = {
  0: TransactionTag.none,
  1: TransactionTag.primer,
  2: TransactionTag.sekunder,
  3: TransactionTag.tersier,
};
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      accountEqualTo(AccountType value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      tagEqualTo(TransactionTag value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'tag',
        value: value,
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      tagBetween(
    TransactionTag lower,
    TransactionTag upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> sortByTag() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQuerySortThenBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy> thenByTag() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tag', Sort.asc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct> distinctByTag() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, AccountType, QQueryOperations>
      accountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, TransactionTag, QQueryOperations>
      tagProperty() {
    return QueryBuilder.apply(this, (query) {
